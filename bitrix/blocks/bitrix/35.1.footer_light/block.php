	...
	<div class="container">
		<div class="row">
			<div class="landing-block-node-main-card js-animation fadeInLeft col-sm-12 col-md-6 col-lg-6 g-mb-25 g-mb-0--lg">
				<h2 class="landing-block-node-title landing-semantic-subtitle-small text-uppercase g-font-weight-700 g-font-size-16 g-mb-20">
					Contact us</h2>
				<div class="landing-block-node-text landing-semantic-text-medium g-mb-20">
				...
				<address class="g-mb-20">
					...
					<div class="landing-block-card-contact g-pos-rel d-flex g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link landing-semantic-link-medium g-font-weight-700"
							   href="tel:#crmPhone1"
							   target="_blank">
								#crmPhoneTitle1
							</a>
					...
					<div class="landing-block-card-contact g-pos-rel d-flex g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link landing-semantic-link-medium g-font-weight-700" href="mailto:#crmEmail1" target="_blank">#crmEmailTitle1</a>
						</div>
					</div>
				</address>
			...
			<div class="landing-block-node-column js-animation fadeInRight col-sm-12 col-md-2 col-lg-2 g-mb-25 g-mb-0--lg">
				...
				<ul class="landing-block-card-list1 list-unstyled g-mb-30">
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Proin vitae est lorem</a>
					</li>
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Aenean imperdiet nisi</a>
					</li>
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Praesent pulvinar
							gravida</a>
					</li>
					<li class="landing-block-card-list1-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Integer commodo est</a>
					</li>
				</ul>
			</div>
			...
			<div class="landing-block-node-column js-animation bounceInRight col-sm-12 col-md-2 col-lg-2 g-mb-25 g-mb-0--lg">
				...
				<ul class="landing-block-card-list2 list-unstyled g-mb-30">
					<li class="landing-block-card-list2-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Vivamus egestas sapien</a>
					</li>
					<li class="landing-block-card-list2-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Sed convallis nec enim</a>
					</li>
					<li class="landing-block-card-list2-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Pellentesque a tristique
							risus</a>
					</li>
					<li class="landing-block-card-list2-item g-mb-10">
						<a class="landing-block-node-list-item landing-semantic-menu-h-text" href="#">Nunc vitae libero
							lacus</a>
					</li>
				</ul>
			</div>
