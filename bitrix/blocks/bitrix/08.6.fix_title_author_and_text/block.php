<section class="landing-block g-pt-0 g-pb-30 g-pt-30">
	<div class="landing-block-node-container container">
		<article class="landing-block-card g-brd-bottom js-animation fadeIn g-mb-40 g-mb-0--last">
			<div class="landing-block-bottom-border g-brd-bottom g-brd-1 g-brd-primary g-pb-25 ">
				<h4 class="landing-block-title landing-semantic-title-medium g-mb-1">
				...
				<div class="media g-flex-centered">
					...
					<div class="landing-block-author landing-semantic-text-medium media-body g-mt-14">
						<p>John Doe</p>
					</div>
				</div>
				<div class="landing-block-text landing-semantic-text-medium g-mb-15 g-pt-1">
				...
				<div class="landing-block-bottom landing-semantic-text-small">
