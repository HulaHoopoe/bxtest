<header class="landing-block landing-semantic-background-color g-bg-white u-header u-header--sticky u-header--relative g-z-index-9999 g-pt-15 g-pb-15">
	<div class="u-header__section u-header__section--light g-transition-0_3"
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg g-py-0 g-px-0 g-pb-15 u-underline-v1 g-brd-main">

				<img class="landing-block-node-menu-logo col u-header__logo-img u-header__logo-img--main g-max-width-180 navbar-brand u-header__logo p-0"
					src="https://cdn.bitrix24.site/bitrix/images/landing/logos/wedding-logo.png" alt="">

				<!-- Navigation -->
				<div class="collapse navbar-collapse align-items-center col flex-sm-row" id="navBar">
				...
				<div class="landing-block-node-contacts-container col-md-6 col-12 g-pr-0 text-right row justify-content-end align-items-center">
					...
					<div class="landing-block-node-contacts-buttons g-ml-15">
						<a class="landing-block-node-contact-button btn text-uppercase g-btn-primary g-btn-type-solid g-btn-size-sm g-btn-px-s rounded-0" href="#">
							Order now
						</a>
					</div>
					<div class="landing-block-node-contacts-socials g-ml-15">
						<div class="landing-block-node-contact-social row no-gutters">
							<div class="d-block u-icon-v3 u-icon-size--sm g-rounded-50x g-bg-gray-light-v4 g-color-gray-light-v1">
								<i class="landing-block-card-social-icon fab fa-twitter g-color-white g-bg-main"></i>
							</div>
							<div class="d-block u-icon-v3 u-icon-size--sm g-rounded-50x g-bg-gray-light-v4 g-color-gray-light-v1">
								<i class="landing-block-card-social-icon fab fa-facebook g-color-white g-bg-main"></i>
							</div>
							<div class="d-block u-icon-v3 u-icon-size--sm g-rounded-50x g-bg-gray-light-v4 g-color-gray-light-v1">
								<i class="landing-block-card-social-icon fab fa-instagram g-color-white g-bg-main"></i>
							</div>
						</div>
					</div>
				</div>
