<section class="landing-block landing-semantic-background-color g-bg-gray-light-v5">
			...
			<div class="landing-block-card landing-block-node-block col-lg-4 js-animation fadeIn g-mb-30">
				<article class="landing-semantic-bg-color-additional g-bg-white">
					<figure class="g-pos-rel">
						...
						<div class="landing-block-node-date g-pos-abs g-bottom-20 g-left-20 g-px-10 rounded-0 g-color-white g-bg-black">July 08, 2022</div>
					</figure>
			...
			<div class="landing-block-card landing-block-node-block col-lg-4 js-animation fadeIn g-mb-30">
				<article class="landing-semantic-bg-color-additional g-bg-white">
					<figure class="g-pos-rel">
						...
						<div class="landing-block-node-date g-pos-abs g-bottom-20 g-left-20 g-px-10 rounded-0 g-color-white g-bg-black">June 15, 2022</div>
					</figure>
					<div class="landing-block-card-block">
						<div class="g-px-30">
							<h3 class="landing-block-node-title landing-semantic-subtitle-medium g-mt-20 g-mb-20">
			...
			<div class="landing-block-card landing-block-node-block col-lg-4 js-animation fadeIn g-mb-30">
				<article class="landing-semantic-bg-color-additional g-bg-white">
					<figure class="g-pos-rel">
						...
						<div class="landing-block-node-date g-pos-abs g-bottom-20 g-left-20 g-px-10 rounded-0 g-color-white g-bg-black">May 26, 2022</div>
					</figure>
					<div class="landing-block-card-block">
						<div class="g-px-30">
							<h3 class="landing-block-node-title landing-semantic-subtitle-medium g-mt-20 g-mb-20">
						...
						<div class="landing-block-bottom-block media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-flex-centered">
							<img class="landing-block-node-author-img g-width-20 g-height-20 g-object-fit-cover d-flex mr-2 g-rounded-50x g-width-20 g-height-20 g-my-15 g-mr-10 g-ml-30" src="https://cdn.bitrix24.site/bitrix/images/landing/business/100x100/img3.jpg" alt="">
							<div class="landing-block-node-author landing-semantic-text-small media-body align-self-center g-mr-30 g-mt-13">
								<p>James Doe</p>
							</div>
						</div>
