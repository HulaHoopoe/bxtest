<section class="landing-block g-overflow-hidden">
	<div class="landing-block-node-card-img g-min-height-100vh g-flex-centered g-bg-cover g-bg-pos-center g-bg-img-hero g-bg-black-opacity-0_5--after"
		...
		<div class="container text-center g-z-index-1 g-mx-0">
			<h2 class="landing-block-node-card-title landing-semantic-title-image-medium g-max-width-800 mx-auto text-uppercase g-font-weight-700 g-color-white g-mb-20 js-animation fadeInUp">
