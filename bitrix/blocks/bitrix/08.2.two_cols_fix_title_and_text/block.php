		...
		<div class="row landing-block-inner">
			<div class="landing-block-card js-animation fadeIn col-lg-6 g-mb-40 g-mb-0--lg">
				<div class="landing-block-card-header text-uppercase u-heading-v2-4--bottom text-left g-brd-primary g-mb-20">
					<h6 class="landing-block-node-subtitle landing-semantic-subtitle-small g-font-weight-700 g-letter-spacing-1 g-color-primary g-mb-20">Our projects</h6>
					<h2 class="landing-block-node-title landing-semantic-title-medium h1 u-heading-v2__title g-line-height-1_3 g-font-weight-700 g-text-break-word">We are the
						<br> best</h2>
				</div>
